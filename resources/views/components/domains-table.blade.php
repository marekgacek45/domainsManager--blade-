            ...
            @foreach ($domains as $domain)
                <tr
                    ...
                    <td class="px-6 py-4 flex justify-center items-center gap-4">
                        ...
                        <a href="{{ route('edit', $domain->id) }}"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
